...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <!--  <form class="form-inline ml-3">
    ...
    <a href="{{route('logout')}}" class="btn btn-info">Sign out</a>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Chat-admin</span>
    </a>
 ...
 -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date('Y')?> <a href="http://adminlte.io">Chat-admin</a></strong>
  <!--   All rights reserved. -->
...
<script src="{{asset('assets/plugins/toastr/toastr.min.js')}}"></script>
 ...
 @include('Admin.parsial.message_parsial')
